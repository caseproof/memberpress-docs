...
- action: [mepr_evt_{$this_>event}]({{ '/actions-and-filters/mepr_evt_' | prepend: site.baseurl }})
- action: [mepr_event_{$this_>event}]({{ '/actions-and-filters/mepr_event_' | prepend: site.baseurl }})
